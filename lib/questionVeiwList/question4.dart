                  ...
                  return Column(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          "Question ${index + 1}/${level4.length}",
                      ...
                      for (int i = 0; i < level4[index].answer!.length; i++)
                        Container(
                          width: double.infinity,
                          ...
                          child: MaterialButton(
                            shape: StadiumBorder(),
                            color: isPressed
                                ? level4[index].answer!.entries.toList()[i].value
                                    ? isTrue
                                    : isWrong
                                : secondColor,
                            ...
                            onPressed: isPressed
                                ...
                                : () {
                                    ...
                                    if (level4[index].answer!.entries
                                        .toList()[i]
                                        .value) {
                                      score += 10;
                                    }
                            ...
                            child: Text(
                              level4[index].answer!.keys.toList()[i],
                              style: const TextStyle(
